...
export default function Location() {
  return (
    <div className="min-h-screen flex flex-col sm:pt-[8.333vh]">
      ...
      <div className="flex-1 flex flex-col sm:flex-row space-y-4 sm:space-y-0 p-2 pt-0 sm:space-x-2 lg:space-x-4 sm:mt-10 justify-center">
        <iframe
          ...
          className="w-full sm:max-w-2xl h-70 sm:h-100 rounded border-4 border-[#007c3c]"
          allowFullScreen
          loading="lazy"
